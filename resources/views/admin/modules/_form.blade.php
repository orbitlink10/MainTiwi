...
<div class="field"><label>Small description</label><textarea name="short_description" required>{{ old('short_description', $module->short_description) }}</textarea>@error('short_description')<span class="error">{{ $message }}</span>@enderror</div>
<div class="field"><label>Full description</label><textarea name="full_description">{{ old('full_description', $module->full_description) }}</textarea>@error('full_description')<span class="error">{{ $message }}</span>@enderror</div>
